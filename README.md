# Custom-Slider
This is an easy-to-use custom range slider with [14 configurable options](https://google.com). It is developed using HTML, CSS, and Vanilla JS with no additional modules required.
